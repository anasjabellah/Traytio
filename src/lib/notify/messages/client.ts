...
export const CLIENT = {
  ...
  HAS_COMMANDES: "Impossible de supprimer ce client car il possède des commandes.",
  HAS_PAYMENTS: "Impossible de supprimer ce client car il possède des paiements liés.",
  ACTIVE_COMMANDES_WARNING: "Ce client possède des commandes et ne peut pas être supprimé.",
