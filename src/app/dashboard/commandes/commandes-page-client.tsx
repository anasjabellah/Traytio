...
import type { CommandesPageResult } from '@/features/commandes/actions/get-commandes-page';
...
interface CommandesPageClientProps {
  initialData?: CommandesPageResult | null;
}

export function CommandesPageClient({ initialData }: CommandesPageClientProps) {
