...
function NouvelleCommandePage() {
  ...
  const { state, derived, handlers, packs, menuItems, clients, isClientsLoading, selectedEvent, showEventForm, clientEvents, clientEventsLoading, isSubmitting, handleSubmit } = form;
