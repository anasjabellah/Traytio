...
export default function CommandeEditView({ commande }: { commande: CommandeWithDetails }) {
  ...
  const { state, derived, handlers, packs, menuItems, clients, isClientsLoading, showEventForm, isSubmitting, handleSubmit } = form;
