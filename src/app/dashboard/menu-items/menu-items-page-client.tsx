...
import type { MenuItem, MenuItemCategory, PaginatedMenuItems } from '@/features/menu-items/types';
...
export function MenuItemsPageClient({ initialData }: MenuItemsPageClientProps) {
  return (
    <PageGuard module="menu-items" action="read">
      <MenuItemsPageContent initialData={initialData} />
    </PageGuard>
  )
}

function MenuItemsPageContent({ initialData }: { initialData?: PaginatedMenuItems | null }) {
